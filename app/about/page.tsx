    ...
    <div className="min-h-screen pt-24 px-6 md:px-16 lg:px-32 bg-gray-50">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          We are committed to delivering excellence and meaningful impact through our work.
        </p>
      </div>
      ...
      <section className="mb-12 grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 animate-bounce inline-block">Our Story</h2>
        ...
        <Image
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRREsvneLimlNmFv6NVFEyLa8aHE_wFzYARrw&s"
          width={500}
          height={400}
          alt="About"
          className="rounded-lg shadow-lg object-cover w-full h-auto hover:animate-pulse"
        />
      </section>

      {/* Mission & Vision */}
      <section className="mb-12 grid md:grid-cols-2 gap-8">
        <div className="border-black p-8 rounded-2xl shadow-lg hover:shadow-[#FF7A00] flex flex-col items-center transition">
          <h2 className="text-2xl font-semibold mb-2">Our Mission</h2>
          <p className="text-gray-700">
            To provide world-class solutions that empower businesses and individuals to thrive in the digital era.
          </p>
        </div>
        <div className= "border-black p-8 rounded-2xl shadow-lg hover:shadow-[#FF7A00] flex flex-col items-center transition">
          <h2 className="text-2xl font-semibold mb-2">Our Vision</h2>
          <p className="text-gray-700">
            To become a global leader recognized for innovation, quality, and customer satisfaction.
          </p>
        </div>
      </section>
      ...
      <section className="mb-12 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            <div key={index} className="p-6 border rounded-lg shadow-sm bg-white hover:shadow-lg transition-shadow">
